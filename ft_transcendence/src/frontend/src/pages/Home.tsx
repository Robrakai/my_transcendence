...
function Home() {
  return (
    <div className="p-5">
      	{/* <Link to="/home" className="text-base text-xl font-arcade">ft_transcendence</Link> */}
		...
		<div>
			...
			<div className="fixed top-25 bottom-40 left-8 w-40 bg-gradient-to-b from-violet-500/50 to-fuchsia-500/50 rounded-xl shadow-md transform -translate-x-full transition-transform duration-300 peer-checked:translate-x-0 z-40">
				<nav className="flex flex-col my-35 space-y-15 justify-items-center auto-cols-auto	">
					...
					{/* <Link to="/home" className="flex p-1 mx-1 text-orange-300/80 font-arcade text-xl justify-center hover:scale-110 hover:shadow-xl transition">Home</Link>
...
{/*
		<div className="absolute top-10 right-20 z-10">
			<Button label="Clique-moi" onClick={() => alert("Hello !")} />
		</div> */}
		...
		<div className="flex flex-col items-center justify-center h-screen space-y-100">
			...
			<a href="welcome" className="text-base text-2xl translate-y-50 font-arcade transition-transform duration-1700 peer-checked:-translate-y-500">WELCOME</a>
			<label htmlFor="welcome" className="peer absolute inset-0 w-full h-full opacity-0 cursor-pointer z-40  peer-checked:z-0"></label>
			{/* <h1 for="welcome" className="flex rounded-full items-center translate-y-200 justify-center w-128 z-10 transition ease-in-out dela-100 bg-pink-200 font-bold p-5 shadow-2xl text-white text-2xl font-arcade dark:bg-black-950  hover:bg-yellow-500 hover:italic hover:text-white-500 hover:shadow-inner hover:outline hover:ouline-4 hover:scale-110 hover:outline-cyan-500 hover:backdrop-blur  transition-transform duration-1700 peer-checked:-translate-y-50"> PLAY </h1> */}
		</div>
